...
const projects = [
  ...
  },
  {
    ...
    description: "Built using the Next.js framework and a JavaScript webscraper to create a prototype for the leaderboard now currently being used by the entire 45-person Stanford Math Tournament organization.",
